    ...
    <div className="min-h-screen bg-bca-dark">
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-bca-gray-light">
      ...
      <section className="pb-24 px-4">
        <div className="max-w-4xl mx-auto bg-bca-dark-card/50 backdrop-blur-sm rounded-xl border border-white/10 p-8 md:p-12">
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-bca-gray-light mb-4">
            ...
            <ul className="text-bca-gray-light mb-6 space-y-2">
            ...
            <div className="text-bca-gray-light">
