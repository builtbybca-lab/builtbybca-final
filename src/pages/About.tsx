...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-bca-dark">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-bca-gray-light text-lg mb-6">
                At Bergen County Academies, we believe in nurturing curious minds and fostering innovation. 
                Our mission is to provide students with cutting-edge education that prepares them for success 
                in an ever-evolving technological landscape.
              </p>
              <p className="text-bca-gray-light text-lg">
                We combine rigorous academics with hands-on experience, mentorship from industry professionals, 
                and opportunities to work on real-world projects that make a difference in our community and beyond.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-bca-dark-card/50 backdrop-blur-sm rounded-xl border border-white/10 p-6 text-center hover:border-bca-red/30 transition-all duration-300"
              >
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-bca-dark-card/30 backdrop-blur-sm rounded-2xl border border-white/10 p-8 md:p-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">Our History</h2>
            
            <div className="space-y-8">
              <div className="border-l-4 border-bca-red pl-6">
                <h3 className="text-xl font-bold text-white mb-2">1991 - Foundation</h3>
                <p className="text-bca-gray-light">
                  Bergen County Academies was established as a specialized high school dedicated to providing 
                  advanced education in science, technology, engineering, and mathematics.
                </p>
              </div>
              
              <div className="border-l-4 border-bca-red pl-6">
                <h3 className="text-xl font-bold text-white mb-2">2000s - Expansion</h3>
                <p className="text-bca-gray-light">
                  Expanded programs to include computer science, biotechnology, and engineering design, 
                  establishing partnerships with leading universities and technology companies.
                </p>
              </div>
              
              <div className="border-l-4 border-bca-red pl-6">
                <h3 className="text-xl font-bold text-white mb-2">2010s - Innovation</h3>
                <p className="text-bca-gray-light">
                  Launched our Innovation Lab and maker spaces, providing students with cutting-edge 
                  tools and resources to bring their creative ideas to life.
                </p>
              </div>
              
              <div className="border-l-4 border-bca-red pl-6">
                <h3 className="text-xl font-bold text-white mb-2">Today - Leadership</h3>
                <p className="text-bca-gray-light">
                  Continuing to lead in STEM education with industry partnerships, research opportunities, 
                  and a track record of preparing students for success in top universities and careers.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div
                key={index}
                className="bg-bca-dark-card/50 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden hover:border-bca-red/30 transition-all duration-300"
              >
