  ...
  return <div className="min-h-screen bg-background">
    ...
    <section className="py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => <div key={index} className="bg-card/50 backdrop-blur-sm rounded-xl border border-border p-6 text-center hover:border-bca-red/30 transition-all duration-300">
    ...
    <section className="py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, index) => <div key={index} className="bg-card/50 backdrop-blur-sm rounded-xl border border-border overflow-hidden hover:border-bca-red/30 transition-all duration-300">
