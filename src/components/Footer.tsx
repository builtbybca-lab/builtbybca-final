...
const Footer = () => {
  ...
  return <footer className="relative bg-bca-dark-card border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center space-x-4">
              {socialLinks.map((social, index) => <a key={index} href={social.href} className="p-2 bg-bca-dark-lighter rounded-lg hover:bg-bca-red transition-colors group" aria-label={social.label}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => <li key={index}>
                  <Link to={link.href} className="text-bca-gray-light hover:text-bca-red transition-colors">
                    {link.label}
                  </Link>
                </li>)}
            </ul>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:BUILTBY.BCA@GMAIL.COM" className="text-bca-gray-light hover:text-bca-red transition-colors">
