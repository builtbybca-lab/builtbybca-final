                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative animate-fade-up" style={{ animationDelay: "0.2s" }}>
                        <div className="aspect-video rounded-2xl bg-card border border-border overflow-hidden shadow-2xl relative group">
                            <img src="/who-we-are.jpg" alt="BuiltBy.BCA Students" className="w-full h-full object-cover" />
                            <div className="absolute inset-0 bg-gradient-to-tr from-bca-red/20 to-transparent opacity-40 group-hover:opacity-60 transition-opacity"></div>
                        </div>
