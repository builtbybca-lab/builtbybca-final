...
const StandoutSection = () => {
  const features = [
    "Highly Experienced Mentors (with cultural connectivity)",
    "Inclusive Student Leadership",
    "Industry Oriented Training",
    "Opportunities Coaching",
    "Best Participants For All",
  ];
  ...
  return (
    <section className="py-20 relative">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex items-center justify-start space-x-4 p-4 card-glass rounded-lg group hover:scale-105 transition-all duration-300 animate-fade-up"
      ...
      <div className="absolute bottom-10 left-10 w-32 h-32 bg-bca-red/5 rounded-full blur-xl animate-float" style={{ animationDelay: "3s" }}></div>
    </section>
  );
};
